...
class WebsosoSearchEditText
    ...
    constructor(
        ...
        fun setOnWebsosoSearchFocusChangeListener(onWebsosoSearchFocusChangeListener: OnFocusChangeListener) {
            externalFocusChangeListener = onWebsosoSearchFocusChangeListener
        }

        // Sets a custom action listener for the search input field
        fun setOnWebsosoSearchActionListener(onWebsosoSearchActionListener: TextView.OnEditorActionListener) {
            externalActionListener = onWebsosoSearchActionListener
        }

        // Sets a custom click listener for the clear button
        fun setOnWebsosoSearchClearClickListener(onWebsosoSearchClearClickListener: OnClickListener) {
        ...
        fun getWebsosoSearchText(): String = binding.etCommonSearch.text.toString()

        // Checks if the search input field is focused
        fun getIsWebsosoSearchFocused(): Boolean = binding.etCommonSearch.hasFocus()
    }
